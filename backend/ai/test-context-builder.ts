...
async function main() {
  ...
  console.log(JSON.stringify(await getHotelHealth(hotel.id), null, 2));

  console.log(`\n=== getScanHistory("${hotel.name}") ===`);
  console.log(JSON.stringify(await getScanHistory(hotel.id), null, 2));

  console.log("\n=== getTopOpportunities(5) ===");
  console.log(JSON.stringify(await getTopOpportunities(5), null, 2));

  console.log("\n=== getHotelsWithoutRecentScan(30) ===");
  console.log(JSON.stringify(await getHotelsWithoutRecentScan(30), null, 2));
